...
export function CardSeries({ id, category, statusTv }) {
    ...
    return (
        <Link to={`/series/${id}/${nameSerie}`} className='cursor-pointer h-auto bg-[#1a1a1a] w-full rounded-b mb-2  hover:scale-105 duration-300 relative' id={movieId}>
