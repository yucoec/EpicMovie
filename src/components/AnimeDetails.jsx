...
import SeasonListAnime from './SeasonListAnime'
...
const AnimeDetails = ({ details, backPage }) => {
                ...
                {serie.map(({ season_number, id: season_id, episodes }) => {
                    return (
                        temporadaSeleccionada === season_number && (
                            <SeasonListAnime key={season_id} id={id} season_number={season_number} episodes={episodes} name={details.name} />
                        )
                    );
                })}
            </section>
